...
export declare type Action = UnitBuildingAbilityActionNoParams | UnitBuildingAbilityActionTargetPositionTargetObjectId | GiveItemToUnitAciton | UnitBuildingAbilityActionTwoTargetPositions | ChangeSelectionAction | AssignGroupHotkeyAction | SelectGroupHotkeyAction | SelectSubgroupAction | SelectGroundItemAction | CancelHeroRevival | RemoveUnitFromBuildingQueue | W3MMDAction | ESCPressedAction | ChooseHeroSkillSubmenu | EnterBuildingSubmenu | TransferResourcesAction | UnitBuildingAbilityActionTargetPosition;
